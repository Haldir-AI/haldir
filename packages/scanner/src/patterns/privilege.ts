...
export const privilegePatterns: ThreatPattern[] = [
  ...
  {
    id: 'sudoers_modification',
    category: 'privilege_escalation',
    severity: 'critical',
    name: 'Sudoers file modification',
    description: 'Attempts to modify sudoers configuration for privilege escalation',
    regex: /\/etc\/sudoers(?:\.d\/)?/,
  ...
  {
    id: 'prototype_pollution_proto',
    category: 'privilege_escalation',
    severity: 'high',
    name: 'Prototype pollution (__proto__)',
    description: 'Accesses __proto__ which can pollute Object.prototype and bypass security checks',
    regex: /__proto__/,
    fileExtensions: [...CODE_EXTENSIONS, 'json'],
  },
  {
    id: 'prototype_pollution_constructor',
    category: 'privilege_escalation',
    severity: 'high',
    name: 'Prototype pollution (constructor.prototype)',
    description: 'Accesses constructor.prototype to pollute Object.prototype',
    regex: /constructor\s*[\[.]\s*(?:prototype|__proto__)/,
    fileExtensions: CODE_EXTENSIONS,
  },
];
